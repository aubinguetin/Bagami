...
export const countryCodes: CountryCode[] = [
  ...
  { name: "Korea, Democratic People's Republic", code: "KP", dialCode: "+850", flag: "🇰🇵" },
  ...
  { name: "Virgin Islands, British", code: "VG", dialCode: "+1", flag: "🇻🇬" },
  { name: "Virgin Islands, U.S.", code: "VI", dialCode: "+1", flag: "🇻🇮" },
...
// Use United States as default (more globally common)
export const getDefaultCountry = () => countryCodes.find(c => c.code === 'US') || countryCodes[0];